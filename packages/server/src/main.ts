...
let courses: Course[] = [
  {
    id: '1',
    title: 'Angular monorepo con NX',
    description: 'Aprendé a utilizar arquitectura monorepo',
    teacher: 'Sergie Code',
  },
...

  {
    ...
    description: 'Aprendé esta poderosa tecnología de backend de Google',
    teacher: 'Jim Morrison',
  },
];
